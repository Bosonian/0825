...
var Vt=Object.defineProperty;var Ut=(a,e,t)=>e in a?Vt(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var Ze=(a,e,t)=>Ut(a,typeof e!="symbol"?e+"":e,t);import{s as h,v as Wt,D as yt,b as qt,A as Ie,K as U,G as ee,C as bt,c as Xe,m as ie,M as ne,a as fe,P as Gt}from"./medical-core-BGk_aHbc.js";import{p as Kt,a as jt,b as Yt,A as Qt,T as Jt,e as wt,c as Zt}from"./prediction-models-DCU63o_D.js";import{t as o,i as W,a as ye,s as Xt,c as es,r as kt,b as St,d as ts,e as et,f as tt,q as Be}from"./research-tools-BkedTj7J.js";import{s as be,a as st,m as f,L as E,b as le,c as v,E as _,d as M,M as H,e as Me,f as at,g as it}from"./enterprise-features-DIAO-rWl.js";import{r as ve,R as Q,c as nt}from"./vendor-MujBQnBx.js";import{i as ss,r as Et,a as as,b as is,C as ns}from"./ui-components-tkCfQkE0.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const os=()=>[{id:"acute_deficit",checked:!1},{id:"symptom_onset",checked:!1},{id:"no_preexisting",checked:!1},{id:"no_trauma",checked:!1}];function rs(){const a=os();return`
  ...
  `}function ls(){const a=document.getElementById("prerequisitesModal");if(!a)return;const e=document.getElementById("closePrerequisites"),t=document.getElementById("cancelPrerequisites"),s=document.getElementById("confirmPrerequisites"),n=()=>{a.remove(),ce("welcome")};e==null||e.addEventListener("click",n),t==null||t.addEventListener("click",n),s==null||s.addEventListener("click",r=>{r.preventDefault(),r.stopPropagation();const c=a.querySelectorAll(".toggle-input");if(Array.from(c).every(p=>p.checked))a.remove(),ce("triage2");else{const p=document.getElementById("prerequisitesWarning");p&&(p.style.display="flex",p.classList.add("shake"),setTimeout(()=>p.classList.remove("shake"),500))}});const i=a.querySelectorAll(".toggle-input");i.forEach(r=>{r.addEventListener("change",()=>{const c=Array.from(i).every(p=>p.checked),u=document.getElementById("prerequisitesWarning");c&&u&&(u.style.display="none")})})}function cs(){const a=document.getElementById("prerequisitesModal");a&&a.remove();const e=document.createElement("div");try{be(e,rs());const t=e.firstElementChild;if(!t)throw new Error("Failed to create modal element");document.body.appendChild(t)}catch(t){console.error("Prerequisites modal sanitization failed:",t);const s=document.createElement("div");s.className="modal prerequisites-modal",s.style.display="flex",s.textContent="Prerequisites modal could not be displayed securely. Please refresh the page.",document.body.appendChild(s);return}ls()}function ds(a){h.logEvent("triage1_answer",{comatose:a}),a?ce("coma"):cs()}function us(a){h.logEvent("triage2_answer",{examinable:a}),ce(a?"full":"limited")}function ce(a){h.logEvent("navigate",{from:h.getState().currentScreen,to:a}),h.navigate(a),window.scrollTo(0,0)}function ps(){h.hasUnsavedData()&&!confirm("Are you sure you want to start over? All entered data will be lost.")||(h.logEvent("reset"),h.reset())}function hs(){h.goBack()?(h.logEvent("navigate_back"),window.scrollTo(0,0)):Tt()}function Tt(){h.logEvent("navigate_home"),h.goHome(),window.scrollTo(0,0)}async function ms(a,e){var u,p;a.preventDefault();const t=a.target,{module:s}=t.dataset,n=Wt(t);if(!n.isValid){qt(e,n.validationErrors);try{const l=Object.keys(n.validationErrors)[0];if(l&&t.elements[l]){const b=t.elements[l];b.focus({preventScroll:!0}),b.scrollIntoView({behavior:"smooth",block:"center"})}const d=document.createElement("div");d.className="sr-only",d.setAttribute("role","status"),d.setAttribute("aria-live","polite");const m=Object.keys(n.validationErrors).length;d.textContent=`${m} field${m===1?"":"s"} need attention.`,document.body.appendChild(d),setTimeout(()=>d.remove(),1200)}catch(l){}return}const i={};Array.from(t.elements).forEach(l=>{if(l.name)if(l.type==="checkbox")i[l.name]=l.checked;else if(l.type==="number"){const d=parseFloat(l.value);i[l.name]=isNaN(d)?0:d}else l.type==="hidden"&&l.name==="armparese"?i[l.name]=l.value==="true":i[l.name]=l.value}),h.setFormData(s,i);const r=t.querySelector("button[type=submit]"),c=r?r.innerHTML:"";if(r){r.disabled=!0;try{be(r,`<span class="loading-spinner"></span> ${o("analyzing")}`)}catch(l){console.error("Button loading state sanitization failed:",l),r.textContent=o("analyzing")||"Analyzing..."}}try{console.log("[Submit] Module:",s),console.log("[Submit] Inputs:",i);let l;switch(s){case"coma":l={ich:{...await Yt(i),module:"Coma"},lvo:null};break;case"limited":l={ich:{...await jt(i),module:"Limited"},lvo:{notPossible:!0}};break;case"full":if(l=await Kt(i),console.log("[Submit] Full results:",{ich:!!(l!=null&&l.ich),lvo:!!(l!=null&&l.lvo),ichP:(u=l==null?void 0:l.ich)==null?void 0:u.probability,lvoP:(p=l==null?void 0:l.lvo)==null?void 0:p.probability}),!l||!l.ich)throw new Error("Invalid response structure from Full Stroke API");l.ich&&!l.ich.probability&&l.ich.ich_probability!==void 0&&(l.ich.probability=l.ich.ich_probability,console.log("[Submit] Fixed ICH probability for Full Stroke:",l.ich.probability)),l.ich&&!l.ich.module&&(l.ich.module="Full Stroke"),l.lvo&&!l.lvo.module&&(l.lvo.module="Full Stroke");break;default:throw new Error(`Unknown module: ${s}`)}console.log("[Submit] Setting results in store:",l),h.setResults(l),h.logEvent("models_complete",{module:s,results:l});const d=h.getState();console.log("[Submit] State after setResults:",{hasResults:!!d.results,currentScreen:d.currentScreen}),console.log("[Submit] Navigating to results..."),ce("results"),ot("✅ Results loaded",2e3),setTimeout(()=>{try{const m=h.getState().currentScreen;console.log("[Submit] currentScreen after navigate:",m),m!=="results"&&(h.navigate("results"),ot("🔁 Forced results view",1500))}catch(m){}},0)}catch(l){const d=["localhost","127.0.0.1","0.0.0.0"].includes(window.location.hostname)&&!0;if(s==="full"&&d)try{const b=yt.mockApiResponses.full_stroke,T=b.ich_prediction||{},L=b.lvo_prediction||{},D=parseFloat(T.probability)||0,I=parseFloat(L.probability)||0,J={ich:{probability:D>1?D/100:D,drivers:T.drivers||null,confidence:parseFloat(T.confidence)||.85,module:"Full Stroke"},lvo:{probability:I>1?I/100:I,drivers:L.drivers||null,confidence:parseFloat(L.confidence)||.85,module:"Full Stroke"}};h.setResults(J),h.logEvent("models_complete_fallback",{module:s,reason:l.message}),ce("results");return}catch(b){}let m="An error occurred during analysis. Please try again.";if(l instanceof Qt&&(m=l.message),gs(e,m),r){r.disabled=!1;try{be(r,c)}catch(b){console.error("Button restore sanitization failed:",b),r.textContent="Submit"}}}}function gs(a,e){a.querySelectorAll(".critical-alert").forEach(c=>{var u,p;(p=(u=c.querySelector("h4"))==null?void 0:u.textContent)!=null&&p.includes("Error")&&c.remove()});const t=document.createElement("div");t.className="critical-alert";const s=document.createElement("h4"),n=document.createElement("span");n.className="alert-icon",n.textContent="⚠️",s.appendChild(n),s.appendChild(document.createTextNode(" Error"));const i=document.createElement("p");i.textContent=e,t.appendChild(s),t.appendChild(i);const r=a.querySelector(".container");r?r.prepend(t):a.prepend(t),setTimeout(()=>t.remove(),1e4)}function ot(a,e=2e3){try{const t=document.createElement("div");t.textContent=a,t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.style.cssText=`
      position: fixed;
      top: 16px;
      left: 50%;
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>{t.style.opacity="1"}),setTimeout(()=>{t.style.opacity="0",setTimeout(()=>t.remove(),200)},e)}catch(t){}}class fs{constructor(){this.isAuthenticated=!1,this.sessionToken=null,this.sessionExpiry=null,this.lastActivity=Date.now(),this.setupActivityTracking()}async authenticate(e){return st(async()=>{if(f.info("Authentication attempt started",{category:E.AUTHENTICATION,hasPassword:!!e&&e.length>0,isDevelopment:yt.isDevelopment}),Jt.ensureType(e,"string","authentication password"),!e||e.trim().length===0)throw f.warn("Authentication failed: empty password",{category:E.AUTHENTICATION}),new H("Password is required","EMPTY_PASSWORD",_.VALIDATION,M.MEDIUM);f.debug("Sending authentication request to backend",{category:E.AUTHENTICATION,url:Ie.AUTHENTICATE});const t=await fetch(Ie.AUTHENTICATE,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:e.trim()})});if(!t.ok){let n="Authentication failed",i="AUTH_FAILED";throw t.status===429?(n="Too many authentication attempts. Please wait and try again.",i="RATE_LIMITED"):t.status>=500&&(n="Authentication service temporarily unavailable",i="SERVICE_ERROR"),new H(n,i,_.AUTHENTICATION,t.status>=500?M.HIGH:M.MEDIUM).withContext({statusCode:t.status,url:Ie.AUTHENTICATE})}const s=await t.json();if(!s||typeof s!="object")throw new H("Invalid response from authentication service","INVALID_RESPONSE",_.AUTHENTICATION,M.HIGH);if(s.success){this.isAuthenticated=!0,this.sessionToken=s.session_token,this.sessionExpiry=s.expires_at?new Date(s.expires_at):null,this.lastActivity=Date.now();try{this.storeSecureSession()}catch(n){console.warn("Session storage failed:",n.message)}return{success:!0,message:"Authentication successful",sessionDuration:s.session_duration}}throw await this.delayFailedAttempt(),new H(s.message||"Invalid credentials","INVALID_CREDENTIALS",_.AUTHENTICATION,M.MEDIUM).withContext({remainingAttempts:s.rate_limit_remaining,statusCode:t.status})},{timeout:15e3,fallback:t=>{var s;return{success:!1,message:t instanceof H?t.getUserMessage():"Authentication service unavailable. Please try again.",errorCode:t.code||"NETWORK_ERROR",details:t.message,remainingAttempts:(s=t.context)==null?void 0:s.remainingAttempts}},context:{operation:"user_authentication",endpoint:"authenticate"}})}isValidSession(){return this.isAuthenticated?this.sessionExpiry&&new Date>this.sessionExpiry?(this.logout(),!1):!0:this.checkStoredSession()}async validateSessionWithServer(){return this.sessionToken?st(async()=>{if(["localhost","127.0.0.1","0.0.0.0"].includes(window.location.hostname)&&!0)return this.updateActivity(),!0;const t=await fetch(Ie.AUTHENTICATE,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:"validate_session",session_token:this.sessionToken})});if(!t.ok){if(t.status===401||t.status===403)return this.logout(),!1;throw new H("Session validation service error","VALIDATION_ERROR",_.AUTHENTICATION,M.MEDIUM).withContext({statusCode:t.status})}const s=await t.json();if(!s||typeof s!="object")throw new H("Invalid response from session validation service","INVALID_RESPONSE",_.AUTHENTICATION,M.MEDIUM);return s.success?(this.updateActivity(),!0):(this.logout(),!1)},{timeout:1e4,fallback:e=>(console.warn("Session validation failed, continuing with local session:",e.message),this.isValidSession()),context:{operation:"session_validation",endpoint:"validate_session"}}):!1}updateActivity(){this.lastActivity=Date.now(),this.storeAuthSession()}async logout(){f.info("User logout initiated",{category:E.AUTHENTICATION}),this.isAuthenticated=!1,this.sessionToken=null,this.sessionExpiry=null;try{await le("auth_session",!0),await le("auth_timestamp",!0),await le("session_token",!0),await le("session_expiry",!0),sessionStorage.removeItem("auth_session"),sessionStorage.removeItem("auth_timestamp"),sessionStorage.removeItem("session_token"),sessionStorage.removeItem("session_expiry"),f.info("Session data cleared during logout",{category:E.SECURITY})}catch(e){f.warn("Failed to clear some session data during logout",{category:E.SECURITY,error:e.message})}}async hashPassword(e){return v(async()=>{if(!e||typeof e!="string")throw new H("Invalid input for password hashing","INVALID_INPUT",_.VALIDATION,M.MEDIUM);if(!crypto||!crypto.subtle)throw new H("Crypto API not available","CRYPTO_UNAVAILABLE",_.SECURITY,M.HIGH);const s=new TextEncoder().encode(e),n=await crypto.subtle.digest("SHA-256",s);return Array.from(new Uint8Array(n)).map(c=>c.toString(16).padStart(2,"0")).join("")},{category:_.SECURITY,severity:M.HIGH,timeout:5e3,fallback:()=>{let t=0;for(let s=0;s<e.length;s++){const n=e.charCodeAt(s);t=(t<<5)-t+n,t&=t}return Math.abs(t).toString(16)},context:{operation:"password_hashing",inputLength:e?e.length:0}})}storeSecureSession(){return v(async()=>{if(!this.isAuthenticated||!this.sessionToken)throw new H("Cannot store session: not authenticated","NOT_AUTHENTICATED",_.AUTHENTICATION,M.LOW);if(typeof sessionStorage=="undefined")throw new H("Session storage not available","STORAGE_UNAVAILABLE",_.STORAGE,M.MEDIUM);return sessionStorage.setItem("auth_session","verified"),sessionStorage.setItem("auth_timestamp",this.lastActivity.toString()),sessionStorage.setItem("session_token",this.sessionToken),this.sessionExpiry&&sessionStorage.setItem("session_expiry",this.sessionExpiry.toISOString()),!0},{category:_.STORAGE,severity:M.LOW,timeout:1e3,fallback:e=>(console.warn("Failed to store session:",e.message),!1),context:{operation:"store_session",hasToken:!!this.sessionToken,hasExpiry:!!this.sessionExpiry}})}storeAuthSession(){this.storeSecureSession()}checkStoredSession(){try{return v(async()=>{if(typeof sessionStorage=="undefined")throw new H("Session storage not available","STORAGE_UNAVAILABLE",_.STORAGE,M.LOW);const e=await Me("auth_session",!0),t=await Me("auth_timestamp",!0),s=await Me("session_token",!0),n=await Me("session_expiry",!0);if(e==="verified"&&t&&s){if(n){const r=new Date(n);if(new Date>r)return this.logout(),!1;this.sessionExpiry=r}const i=parseInt(t);if(isNaN(i))throw new H("Invalid session timestamp","INVALID_SESSION_DATA",_.STORAGE,M.MEDIUM);return this.isAuthenticated=!0,this.sessionToken=s,this.lastActivity=i,!0}return this.logout(),!1},{category:_.STORAGE,severity:M.LOW,timeout:1e3,fallback:e=>(console.warn("Failed to check stored session:",e.message),this.logout(),!1),context:{operation:"check_stored_session"}})}catch(e){return this.logout(),!1}}setupActivityTracking(){const e=["mousedown","mousemove","keypress","scroll","touchstart"],t=()=>{this.isAuthenticated&&this.updateActivity()};e.forEach(s=>{document.addEventListener(s,t,{passive:!0})})}async delayFailedAttempt(){return v(async()=>new Promise(e=>{setTimeout(e,1e3)}),{category:_.AUTHENTICATION,severity:M.LOW,timeout:2e3,fallback:()=>Promise.resolve(),context:{operation:"auth_delay"}})}getSessionInfo(){if(!this.isAuthenticated)return{authenticated:!1};const e=this.sessionTimeout-(Date.now()-this.lastActivity),t=Math.floor(e/(60*60*1e3)),s=Math.floor(e%(60*60*1e3)/(60*1e3));return{authenticated:!0,timeRemaining:`${t}h ${s}m`,lastActivity:new Date(this.lastActivity).toLocaleTimeString()}}}const P=new fs;function we(){const a=window.location.hash||"",e=new URLSearchParams(a.split("?")[1]||""),t=e.get("display"),s=e.get("caseId"),n=t==="kiosk"&&!!s;return console.log("[KioskLoader] Kiosk mode detection:",{hash:a,display:t,caseId:s,isKioskMode:n}),{isKioskMode:n,caseId:s}}async function vs(a){try{console.log("[KioskLoader] Fetching case data:",a);const e=await fetch(`${U.caseSharingUrl}/get-cases`,{method:"GET",headers:{"Content-Type":"application/json"}});if(!e.ok)throw new Error(`Failed to fetch cases: ${e.status}`);const s=(await e.json()).cases.find(n=>n.id===a);if(!s)throw new Error(`Case not found: ${a}`);return console.log("[KioskLoader] Case data loaded:",s),s}catch(e){throw console.error("[KioskLoader] Failed to fetch case data:",e),e}}async function ys(a){try{const e=await vs(a);return h.setState({results:e.results,formData:e.formData||{},currentScreen:"results"}),console.log("[KioskLoader] Store populated with case data"),e}catch(e){throw console.error("[KioskLoader] Failed to load kiosk case:",e),e}}function bs(){return"https://igfap.eu/kiosk/"}function Le(a){return getComputedStyle(document.documentElement).getPropertyValue(a).trim()}function ws({percent:a=0,level:e="normal"}){const t=ve.useRef(null),s=ve.useRef(null);return ve.useEffect(()=>{const n=t.current,i=n==null?void 0:n.parentElement;if(!i||!n)return;s.current=i;const r=()=>{const p=window.devicePixelRatio||1,l=i.offsetWidth||120;n.width=Math.max(1,Math.floor(l*p)),n.height=Math.max(1,Math.floor(l*p));const d=n.getContext("2d");d.setTransform(1,0,0,1,0,0),d.scale(p,p);const m=l,b=l,T=m/2,L=b/2,D=l/2-8,I=Math.min(Math.max(D*.12,6),12),J=Math.max(I-2,6),z=I%2===1?D-.5:D;d.clearRect(0,0,m,b);const q=document.body.classList.contains("dark-mode"),de=Le("--border-color")||(q?"#2f3336":"#dee2e6");d.save(),d.globalAlpha=q?.36:.65,d.strokeStyle=de,d.lineWidth=J,d.lineCap="round",d.beginPath(),d.arc(T,L,z,0,Math.PI*2),d.stroke(),d.restore();let R=Le("--primary-color");e==="high"&&(R=Le("--warning-color")||"#ff9800"),e==="critical"&&(R=Le("--danger-color")||"#DC143C"),q&&R.includes("#")&&(e==="high"&&(R="#ffaa00"),e==="critical"&&(R="#ff1744"));const B=-Math.PI/2,j=B+Math.PI*2*(Math.max(0,Math.min(100,a))/100);d.save(),d.strokeStyle=q?"rgba(0,0,0,0.3)":"rgba(0,0,0,0.15)",d.lineWidth=I+1.5,d.beginPath(),d.arc(T,L,z,B,j,!1),d.stroke(),d.restore(),d.strokeStyle=R,d.lineWidth=I,d.beginPath(),d.arc(T,L,z,B,j,!1),d.stroke()},c=requestAnimationFrame(r),u=new ResizeObserver(()=>requestAnimationFrame(r));return u.observe(i),()=>{cancelAnimationFrame(c),u.disconnect()}},[a,e]),Q.createElement(Q.Fragment,null,Q.createElement("div",{className:"probability-number"},Math.round(a),Q.createElement("span",null,"%")),Q.createElement("canvas",{ref:t,className:"probability-canvas"}))}function ks({lvoProb:a=0,ichProb:e=0,title:t="Decision Support – LVO/ICH"}){const s=ve.useRef(null);return ve.useEffect(()=>{const n=s.current;if(!n)return;const i=n.getContext("2d");let r=null,c=.5;const p=Math.max(e,.5),l=a/p,b=Math.max(.5,Math.min(2,l)),T=(Math.log2(b)+1)/2,L=Math.abs(a-e),D=Math.max(a,e);let I=L<10?Math.round(30+D*.3):L<20?Math.round(50+D*.4):Math.round(70+D*.3);I=Math.max(0,Math.min(100,I));const J=()=>{const z=window.devicePixelRatio||1,q=n.getBoundingClientRect(),de=q.width||300,R=q.height||200;n.width=Math.max(1,Math.floor(de*z)),n.height=Math.max(1,Math.floor(R*z)),i.setTransform(1,0,0,1,0,0),i.scale(z,z);const B=de,j=R,V=B<480,se=B>=480&&B<1024,Y=V?12:se?14:16,ue=15,ke=B/2-ue-Y/2,pe=j/2-ue-Y/2,Rt=se?Math.min(pe,j*.42):pe,k=Math.max(10,Math.min(ke,Rt)),g=B/2,y=j-(ue+Y/2+k);i.clearRect(0,0,B,j);const O=document.body.classList.contains("dark-mode"),qe={day:{bezel:"#e8eaed",bezelShadow:"#c1c7cd",track:"#f5f7fa",ich:"#8b1538",lvo:"#1e3a5f",neutral:"#6b7280",needle:"#d4af37",text:"#374151",tickMajor:"#4b5563",tickMinor:"#9ca3af"},night:{bezel:"#2d3036",bezelShadow:"#1a1d23",track:"#383c42",ich:"#dc2626",lvo:"#3b82f6",neutral:"#64748b",needle:"#fbbf24",text:"#f3f4f6",tickMajor:"#d1d5db",tickMinor:"#6b7280"}},A=O?qe.night:qe.day,he=i.createLinearGradient(g-k,y-k,g+k,y+k);he.addColorStop(0,A.bezel),he.addColorStop(.3,A.bezelShadow),he.addColorStop(.7,A.bezel),he.addColorStop(1,A.bezelShadow),i.strokeStyle=he,i.lineWidth=Y+4,i.lineCap="round",i.beginPath(),i.arc(g,y,k+2,0,Math.PI,!1),i.stroke(),i.strokeStyle=A.track,i.lineWidth=Y,i.beginPath(),i.arc(g,y,k,0,Math.PI,!1),i.stroke();const De=60,Ge=Math.PI/De;for(let C=0;C<De;C++){const $=C/(De-1),S=C*Ge,F=Math.min((C+1)*Ge,Math.PI);let x,me,ze;if($<=.5){const re=$*2;x=Math.round(0+242*re),me=Math.round(154+66*re),ze=Math.round(255*(1-re))}else{const re=($-.5)*2;x=Math.round(242+13*re),me=Math.round(220*(1-re)),ze=Math.round(0)}const Bt=`rgba(${x}, ${me}, ${ze}, 0.85)`;i.strokeStyle=Bt,i.lineWidth=Y-4,i.beginPath(),i.arc(g,y,k,S,F,!1),i.stroke()}const Ot=[.5,.75,1,1.5,2],Ft=V?[]:[.6,.9,1.2,1.8];Ot.forEach(C=>{const $=(Math.log2(C)+1)/2,S=Math.PI-$*Math.PI,F=k-12,x=k-24;i.strokeStyle=A.tickMajor,i.lineWidth=1.5,i.lineCap="round",i.beginPath(),i.moveTo(g+Math.cos(S)*F,y+Math.sin(S)*F),i.lineTo(g+Math.cos(S)*x,y+Math.sin(S)*x),i.stroke(),i.fillStyle=A.text;const me=V?13:15;i.font=`600 ${me}px "SF Pro Display", system-ui, sans-serif`,i.textAlign="center",i.textBaseline="middle",i.fillText(C.toFixed(1),g+Math.cos(S)*(k-35),y+Math.sin(S)*(k-35))}),Ft.forEach(C=>{const $=(Math.log2(C)+1)/2,S=Math.PI-$*Math.PI,F=k-8,x=k-16;i.strokeStyle=A.tickMinor,i.lineWidth=.8,i.lineCap="round",i.beginPath(),i.moveTo(g+Math.cos(S)*F,y+Math.sin(S)*F),i.lineTo(g+Math.cos(S)*x,y+Math.sin(S)*x),i.stroke()}),[{val:.77,label:"ICH",side:"left"},{val:1.3,label:"LVO",side:"right"}].forEach(C=>{const $=(Math.log2(C.val)+1)/2,S=Math.PI-$*Math.PI,F=k-2,x=k+12;i.strokeStyle=C.side==="left"?A.ich:A.lvo,i.lineWidth=2,i.setLineDash([3,2]),i.beginPath(),i.moveTo(g+Math.cos(S)*F,y+Math.sin(S)*F),i.lineTo(g+Math.cos(S)*x,y+Math.sin(S)*x),i.stroke(),i.setLineDash([])});const Ht=V?15:17,Se=V?k+35:k+42;i.fillStyle=O?"#ff4444":"#ff0000",i.font=`700 ${Ht}px "SF Pro Display", system-ui, sans-serif`,i.textAlign="center",i.textBaseline="middle",O&&(i.shadowColor="rgba(0,0,0,0.8)",i.shadowBlur=3,i.shadowOffsetY=1),i.fillText("ICH",g+Math.cos(Math.PI)*Se,y+Math.sin(Math.PI)*Se-10),i.fillStyle=O?"#4499ff":"#0099ff",i.fillText("LVO",g+Math.cos(0)*Se,y+Math.sin(0)*Se-10),i.shadowBlur=0,i.shadowOffsetY=0,c+=(T-c)*.12;const Z=Math.PI-c*Math.PI,ae=Math.max(0,k-Y/2-6),Ke=(1-I/100)*(Math.PI*.05);i.save(),i.globalAlpha=O?.2:.25,i.fillStyle=A.neutral,i.beginPath(),i.moveTo(g,y),i.arc(g,y,ae*.85,Z-Ke,Z+Ke,!1),i.closePath(),i.fill(),i.restore();const G=A.needle,Nt=performance.now(),Ee=i.createLinearGradient(g,y,g+Math.cos(Z)*ae,y+Math.sin(Z)*ae);Ee.addColorStop(0,G+"ff"),Ee.addColorStop(.7,G+"dd"),Ee.addColorStop(1,G+"bb"),i.strokeStyle=Ee,i.lineWidth=2.5,i.lineCap="round",i.shadowColor=O?"rgba(0,0,0,0.8)":"rgba(0,0,0,0.3)",i.shadowBlur=4,i.shadowOffsetY=2,i.beginPath(),i.moveTo(g,y),i.lineTo(g+Math.cos(Z)*ae,y+Math.sin(Z)*ae),i.stroke(),i.shadowBlur=0,i.shadowOffsetY=0;const Re=g+Math.cos(Z)*ae,Oe=y+Math.sin(Z)*ae,Te=.6+.4*Math.sin(Nt*.006),Fe=3+Te*2;i.save(),i.globalAlpha=.15+Te*.25,i.fillStyle=G,i.beginPath(),i.arc(Re,Oe,Fe*3.5,0,Math.PI*2),i.fill(),i.restore(),i.save(),i.globalAlpha=.4+Te*.3,i.fillStyle=G,i.beginPath(),i.arc(Re,Oe,Fe*1.8,0,Math.PI*2),i.fill(),i.restore(),i.fillStyle=G,i.shadowColor=G,i.shadowBlur=4+Te*6,i.beginPath(),i.arc(Re,Oe,Fe,0,Math.PI*2),i.fill(),i.shadowBlur=0;const He=14,je=8,Ce=i.createRadialGradient(g,y,0,g,y,He);Ce.addColorStop(0,O?"#4a5568":"#718096"),Ce.addColorStop(.7,O?"#2d3748":"#4a5568"),Ce.addColorStop(1,O?"#1a202c":"#2d3748"),i.fillStyle=Ce,i.beginPath(),i.arc(g,y,He,0,Math.PI*2),i.fill();const Ne=i.createRadialGradient(g,y,0,g,y,je);Ne.addColorStop(0,G+"aa"),Ne.addColorStop(1,G+"44"),i.fillStyle=Ne,i.beginPath(),i.arc(g,y,je,0,Math.PI*2),i.fill(),i.strokeStyle=G,i.lineWidth=1,i.beginPath(),i.arc(g,y,He-1,0,Math.PI*2),i.stroke();const zt=V?18:22,Ye=y-k*.65,Qe=V?60:80,Je=V?24:30;if(i.save(),i.globalAlpha=O?.9:.95,i.fillStyle=O?"#1f2937":"#ffffff",i.shadowColor=O?"rgba(0,0,0,0.5)":"rgba(0,0,0,0.2)",i.shadowBlur=8,i.shadowOffsetY=2,i.fillRect(g-Qe/2,Ye-Je/2,Qe,Je),i.restore(),i.fillStyle=A.text,i.font=`700 ${zt}px "SF Mono", ui-monospace, monospace`,i.textAlign="center",i.textBaseline="middle",i.fillText(b.toFixed(2),g,Ye),!V){const C=y+k*.15,$=60,S=4;i.fillStyle=O?"#374151":"#e5e7eb",i.fillRect(g-$/2,C,$,S);const F=I/100*$,x=i.createLinearGradient(g-$/2,C,g-$/2+F,C);x.addColorStop(0,A.neutral),x.addColorStop(1,A.needle),i.fillStyle=x,i.fillRect(g-$/2,C,F,S),i.fillStyle=A.text,i.font='500 11px "SF Pro Display", system-ui, sans-serif',i.textAlign="center",i.fillText(`${I}% confidence`,g,C+18)}r=requestAnimationFrame(J)};return J(),()=>{r&&cancelAnimationFrame(r)}},[a,e]),Q.createElement("div",{className:"gauge-wrapper"},Q.createElement("canvas",{ref:s,className:"gauge-canvas"}))}function Ss(){document.querySelectorAll("[data-react-ring]").forEach(a=>{if(a.__mounted)return;const e=parseFloat(a.getAttribute("data-percent"))||0,t=a.getAttribute("data-level")||"normal",s=nt(a);s.render(Q.createElement(ws,{percent:e,level:t})),a.__mounted=!0,a.__root=s}),document.querySelectorAll("[data-react-tachometer]").forEach(a=>{if(a.__mounted)return;const e=parseFloat(a.getAttribute("data-ich"))||0,t=parseFloat(a.getAttribute("data-lvo"))||0,s=a.getAttribute("data-title")||"Decision Support – LVO/ICH",n=nt(a);n.render(Q.createElement(ks,{ichProb:e,lvoProb:t,title:s})),a.__mounted=!0,a.__root=n})}function oe(a){const e=[{id:1,labelKey:"progressTriage",icon:"🎯"},{id:2,labelKey:"progressAssessment",icon:"📋"},{id:3,labelKey:"progressResults",icon:"📊"}];let t='<div class="progress-indicator">';return e.forEach((s,n)=>{const i=s.id===a,r=s.id<a,c=W.t(s.labelKey);t+=`
    ...
    `,n<e.length-1&&(t+=`<div class="progress-line ${r?"completed":""}"></div>`)}),t+="</div>",t}function rt(){return`
    <div class="container">
      ${oe(1)}
  ...
  `;return console.log("[Drivers] ICH has drivers:",!!(a!=null&&a.drivers),a==null?void 0:a.drivers),console.log("[Drivers] LVO has drivers:",!!(e!=null&&e.drivers),"notPossible:",e==null?void 0:e.notPossible,e==null?void 0:e.drivers),a!=null&&a.drivers&&(console.log("🧠 Rendering ICH drivers panel"),t+=lt(a.drivers,"ICH","ich",a.probability)),e!=null&&e.drivers&&!e.notPossible&&(console.log("🩸 Rendering LVO drivers panel"),t+=lt(e.drivers,"LVO","lvo",e.probability)),t+=`
      </div>
    </div>
  `,t}function lt(a,e,t,s){if(!a||Object.keys(a).length===0)return`
  ...
  `,u}function _s(a,e){const t=Number(a),s=bt[e];return t>=s.high?"🔴 HIGH RISK":t>=s.medium?"🟡 MEDIUM RISK":"🟢 LOW RISK"}function ct(){const a="ABCDEFGHIJKLMNOPQRSTUVWXYZ",e="0123456789";let t="";for(let s=0;s<3;s++)t+=a.charAt(Math.floor(Math.random()*a.length));for(let s=0;s<4;s++)t+=e.charAt(Math.floor(Math.random()*e.length));return t}async function Ps(){try{const a=ct(),e=Date.now(),t=h.getState(),{results:s,formData:n}=t;if(!s)throw new Error("No assessment results available to share");const i={caseId:a,results:s,formData:n,timestamp:e,sharedAt:new Date().toISOString(),expiresAt:new Date(e+60*60*1e3).toISOString()},r=await fetch(`${U.caseSharingUrl}/store-shared-case`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i)});if(!r.ok)throw new Error(`Failed to store case: ${r.statusText}`);const c=await r.json();console.log("[CaseShareLink] Case stored on backend:",c),localStorage.setItem(`shared_case_${a}`,JSON.stringify(i));const u=window.location.origin,p=window.location.pathname,l=`${u}${p}#/results?caseId=${a}&source=shared&ts=${e}`;return console.log("[CaseShareLink] Generated share link:",l),l}catch(a){console.error("[CaseShareLink] Failed to generate share link:",a);const e=ct(),t=Date.now(),s=h.getState();localStorage.setItem(`shared_case_${e}`,JSON.stringify({caseId:e,results:s.results,formData:s.formData,timestamp:t}));const n=window.location.origin,i=window.location.pathname;return`${n}${i}#/results?caseId=${e}&source=shared&ts=${t}`}}async function Ds(a){try{const t=await fetch(`${U.caseSharingUrl}/get-shared-case/${a}`);if(t.ok){const s=await t.json();return console.log("[CaseShareLink] Loaded case from backend:",a),s}}catch(t){console.warn("[CaseShareLink] Failed to load from backend, trying local storage:",t)}const e=localStorage.getItem(`shared_case_${a}`);if(e)return console.log("[CaseShareLink] Loaded case from local storage:",a),JSON.parse(e);throw new Error("Case not found")}async function Rs(a){try{if(navigator.clipboard&&navigator.clipboard.writeText)return await navigator.clipboard.writeText(a),console.log("[CaseShareLink] Link copied to clipboard"),!0;{const e=document.createElement("textarea");e.value=a,e.style.position="fixed",e.style.opacity="0",document.body.appendChild(e),e.select();const t=document.execCommand("copy");return document.body.removeChild(e),t}}catch(e){return console.error("[CaseShareLink] Failed to copy to clipboard:",e),!1}}function Ue(){const a=new URLSearchParams(window.location.hash.split("?")[1]||""),e=a.get("source"),t=a.get("caseId"),s=parseInt(a.get("ts"))||0,n=e==="shared"&&!!t;return n&&console.log("[CaseShareLink] Detected shared link:",{caseId:t,timestamp:s}),{isShared:n,caseId:t||null,timestamp:s}}function Os(a){if(!a)return!1;const t=Date.now()-a,s=60*60*1e3;return t>s}async function Fs(a){try{console.log("[CaseShareLink] Submitting acknowledgment for case:",a);const e={caseId:a,timestamp:Date.now(),acknowledged:!0};return localStorage.setItem(`ack_${a}`,JSON.stringify(e)),!0}catch(e){return console.error("[CaseShareLink] Failed to submit acknowledgment:",e),!1}}function Hs(a){try{const e=localStorage.getItem(`ack_${a}`);return e?JSON.parse(e).acknowledged===!0:!1}catch(e){return!1}}function It(){const a=h.getState(),{formData:e}=a;if(!e||Object.keys(e).length===0)return"";let t="";return Object.entries(e).forEach(([s,n])=>{if(n&&Object.keys(n).length>0){const i=o(`${s}ModuleTitle`)||s.charAt(0).toUpperCase()+s.slice(1);let r="";Object.entries(n).forEach(([c,u])=>{if(u===""||u===null||u===void 0)return;const p=As(c),l=$s(u,c);r+=`
  ...
  `}function Ns(a){const e=a.gfap_value||We();if(!e||e<=0)return"";const t=wt(e);return`
    <div class="volume-display-container">
      ${as(t)}
    </div>
  `}function We(){var t;const a=h.getState(),{formData:e}=a;for(const s of["coma","limited","full"])if((t=e[s])!=null&&t.gfap_value)return parseFloat(e[s].gfap_value);return 0}function Mt(){const a=Ue();if(!a.isShared)return"";const e=Os(a.timestamp),t=Hs(a.caseId);return`
  ...
  `}function dt(a,e){var t;try{if(!a)return console.error("renderResults: No results data provided"),`
        <div class="container">
      ...
      `;const{ich:s,lvo:n}=a,i=qs(s),r=i!=="coma"?Us(a):null;r&&ye(i)&&Xt(s,r,Pe());const c=(s==null?void 0:s.module)==="Limited"||(s==null?void 0:s.module)==="Coma"||(n==null?void 0:n.notPossible)===!0,u=(s==null?void 0:s.module)==="Full Stroke"||((t=s==null?void 0:s.module)==null?void 0:t.includes("Full"));let p;return console.log("[Results] ICH data:",s),console.log("[Results] LVO data:",n),console.log("[Results] ICH module:",s==null?void 0:s.module),console.log("[Results] isLimitedOrComa:",c),console.log("[Results] isFullModule:",u),c?p=zs(s,a,e,r,i):p=Bs(s,n,a,e,r,i),setTimeout(()=>{console.log("[Results] Initializing volume animations..."),ss()},100),p}catch(s){return console.error("Error in renderResults:",s),`
      <div class="container">
        <div class="error-message">
    ...
    `}}function zs(a,e,t,s,n){const r=we().isKioskMode,c=a&&a.probability>.6?Ct():"",u=Math.round(((a==null?void 0:a.probability)||0)*100),p=Et(),l=It(),d=ye(n)?kt():"",m=s&&ye(n)?St(a,s,Pe()):"",b=(a==null?void 0:a.module)==="Coma"?Ws(a.probability):"",T=(a==null?void 0:a.module)!=="Coma"?$t(a.probability):"";return`
    <div class="container">
      ${oe(3)}
      ${Mt()}
  ...
  `}function Bs(a,e,t,s,n,i){var ke,pe;const c=we().isKioskMode,u=Math.round(((a==null?void 0:a.probability)||0)*100),p=Math.round(((e==null?void 0:e.probability)||0)*100);console.log("[FullModuleResults] ICH probability:",a==null?void 0:a.probability,"-> %:",u),console.log("[FullModuleResults] LVO probability:",e==null?void 0:e.probability,"-> %:",p);const l=a&&a.probability>.6?Ct():"",d=Et(),m=It(),b=ye(i)?kt():"",T=n&&ye(i)?St(a,n,Pe()):"",L=h.getState(),D=parseInt((pe=(ke=L.formData)==null?void 0:ke.full)==null?void 0:pe.fast_ed_score)||0,I=i==="full"||(a==null?void 0:a.module)==="Full",J=e&&typeof e.probability=="number"&&!e.notPossible,z=I&&D>3&&J,q=u>=50,R=p/Math.max(u,.5),B=R>=.6&&R<=1.7,j=I&&u>=50&&p>=50&&!B,V=I&&u>=30&&p>=30;let se=1;z&&se++,q&&se++;const Y=se===1?"risk-results-single":se===2?"risk-results-dual":"risk-results-triple",ue=$t(a.probability);return`
    <div class="container">
      ${oe(3)}
      ${Mt()}
  ...
  `}function Vs(a,e,t){const s=t>1?"LVO":"ICH",n=s==="LVO"?"🧠":"🩸",i=W.getCurrentLanguage()==="de"?s==="LVO"?"LVO-dominant":"ICH-dominant":s==="LVO"?"LVO dominant":"ICH dominant",r=W.getCurrentLanguage()==="de"?`Verhältnis LVO/ICH: ${t.toFixed(2)}`:`LVO/ICH ratio: ${t.toFixed(2)}`;return`
  ...
  `}function Lt(a){if(!a||!a.drivers)return'<p class="no-drivers">No driver data available</p>';const e=a.drivers;if(!e.positive&&!e.negative)return'<p class="no-drivers">Driver format error</p>';const t=e.positive||[],s=e.negative||[];return`
    <div class="drivers-split-view">
      <div class="drivers-column positive-column">
        <div class="column-header">
          <span class="column-icon">⬆</span>
        ...
        <div class="compact-drivers">
          ${t.length>0?t.slice(0,5).map(n=>ut(n,"positive")).join(""):`<p class="no-factors">${o("noFactors")||"Keine Faktoren / No factors"}</p>`}
        </div>
      </div>
      ...
      <div class="drivers-column negative-column">
        ...
        <div class="compact-drivers">
          ${s.length>0?s.slice(0,5).map(n=>ut(n,"negative")).join(""):`<p class="no-factors">${o("noFactors")||"Keine Faktoren / No factors"}</p>`}
        </div>
      </div>
    </div>
  `}function ut(a,e){const t=Math.abs(a.weight*100),s=Math.min(t*2,100);return`
    <div class="compact-driver-item">
  ...
  `}function At(a){if(!a||!a.probability||Math.round((a.probability||0)*100)<50)return"";const t=We();return!t||t<=0?"":`
  ...
  `}function Us(a){try{const e=Pe();return!e.age||!e.gfap?null:es(e)}catch(e){return null}}function Pe(){const a=h.getState(),{formData:e}=a;let t=null,s=null;for(const i of["coma","limited","full"])e[i]&&(t=t||e[i].age_years,s=s||e[i].gfap_value);return{age:parseInt(t)||null,gfap:parseFloat(s)||null}}function $t(a){return Math.round(a*100)>25?`
    ...
    `:""}function Ws(a){const e=Math.round(a*100),t=W.getCurrentLanguage()==="de";return e>25?`
      <div class="alternative-diagnosis-card">
        <div class="diagnosis-header">
          <span class="lightning-icon">⚡</span>
    ...
    `}function qs(a){if(!(a!=null&&a.module))return"unknown";const e=a.module.toLowerCase();return e.includes("coma")?"coma":e.includes("limited")?"limited":e.includes("full")?"full":"unknown"}function xt(a){const e=We();if(!e||e<=0)return"";const t=wt(e),s=Zt(t);return Math.round(((a==null?void 0:a.probability)||0)*100),`
  ...
  `}function Gs(a,e){const t=e/Math.max(a,1);return`
    <div class="tachometer-section">
      <div class="tachometer-card">
  ...
  `}function js(){const a=document.getElementById("loginForm");if(!a)return;const e=document.getElementById("researchPassword"),t=document.getElementById("loginError"),s=a.querySelector(".login-button");e.focus(),a.addEventListener("submit",async c=>{c.preventDefault();const u=e.value.trim();if(!u){n("Please enter the research access code");return}r(!0),i();try{const p=await P.authenticate(u);if(p.success)h.logEvent("auth_success",{timestamp:new Date().toISOString(),userAgent:navigator.userAgent.substring(0,100)}),h.navigate("triage1");else{const l=p.message;n(l),e.value="",e.focus(),h.logEvent("auth_failed",{timestamp:new Date().toISOString(),errorCode:p.errorCode})}}catch(p){n("Authentication system error. Please try again.")}finally{r(!1)}}),e.addEventListener("input",()=>{i()});function n(c){t.textContent=c,t.style.display="block",e.classList.add("error")}function i(){t.style.display="none",e.classList.remove("error")}function r(c){const u=s.querySelector(".button-text"),p=s.querySelector(".loading-spinner");c?(u.style.display="none",p.style.display="inline",s.disabled=!0):(u.style.display="inline",p.style.display="none",s.disabled=!1)}}function Ys(a){const e=document.createElement("div");e.className="sr-only",e.setAttribute("role","status"),e.setAttribute("aria-live","polite");const t={triage1:"Coma assessment",triage2:"Examination capability assessment",coma:"Coma module",limited:"Limited data module",full:"Full stroke assessment",results:"Assessment results"};e.textContent=`Navigated to ${t[a]||a}`,document.body.appendChild(e),setTimeout(()=>e.remove(),1e3)}function Qs(a){const e="iGFAP",s={triage1:"Initial Assessment",triage2:"Examination Capability",coma:"Coma Module",limited:"Limited Data Module",full:"Full Stroke Module",results:"Assessment Results"}[a];document.title=s?`${e} — ${s}`:e}function Js(){setTimeout(()=>{const a=document.querySelector("h2");a&&(a.setAttribute("tabindex","-1"),a.focus(),setTimeout(()=>a.removeAttribute("tabindex"),100))},100)}class Zs{constructor(){this.scores={facial_palsy:0,arm_weakness:0,speech_changes:0,eye_deviation:0,denial_neglect:0},this.onApply=null,this.modal=null}getTotal(){return Object.values(this.scores).reduce((e,t)=>e+t,0)}getRiskLevel(){return this.getTotal()>=4?"high":"low"}render(){const e=this.getTotal(),t=this.getRiskLevel();return`
...
A case is already being tracked. Do you want to stop it and send a new one?`))return;xe.stopTracking(),(e=document.getElementById("trackingStatus"))==null||e.remove()}a.disabled=!0,a.classList.add("sending");const s=a.textContent;a.textContent="⏳ Krankenhaus auswählen... / Selecting Hospital...",ga.show(async n=>{try{a.textContent="📡 Sende Case... / Sending Case...";const i=h.getState(),{results:r,formData:c}=i;if(!r||!r.ich)throw new Error("No assessment results available");const u=wa(r);console.log("[KioskHandlers] Sending case:",{moduleType:u,hospital:n.name,ichRisk:Math.round(r.ich.probability*100)});const p=await xe.sendCase(r,c,u,n);a.classList.remove("sending"),a.classList.add("success"),a.textContent=`✓ Gesendet an / Sent to ${n.name}`,a.disabled=!1,ka(p.caseId,n,p.eta),setTimeout(()=>{a.classList.remove("success"),a.textContent=s},5e3)}catch(i){console.error("[KioskHandlers] Failed to send case:",i),Ea(a,s,i)}})}catch(t){console.error("[KioskHandlers] Hospital selection error:",t),a.classList.remove("sending"),a.textContent="❌ Fehler / Error - Try Again",a.disabled=!1}}function wa(a){if(!a.ich||!a.ich.module)return"unknown";const e=a.ich.module.toLowerCase();return e.includes("coma")?"coma":e.includes("limited")?"limited":e.includes("full")?"full":"unknown"}function ka(a,e,t){const s=document.getElementById("trackingStatus");s&&s.remove();const n=`
  ...
  `,i=document.querySelector(".results-actions");i&&(i.insertAdjacentHTML("afterend",n),setTimeout(()=>{var r;(r=document.getElementById("trackingStatus"))==null||r.scrollIntoView({behavior:"smooth",block:"nearest"})},100))}function Sa(){if(confirm(`Möchten Sie das Live-Tracking beenden?

Do you want to stop live tracking?`)){xe.stopTracking();const e=document.getElementById("trackingStatus");e&&(e.style.transition="opacity 0.3s ease",e.style.opacity="0",setTimeout(()=>{e.remove()},300)),console.log("[KioskHandlers] Tracking stopped by user")}}function Ea(a,e,t){a.classList.remove("sending"),a.classList.add("error");let s="❌ Fehler / Error";t.message.includes("GPS")||t.message.includes("location")?s="❌ GPS-Fehler / GPS Error":(t.message.includes("network")||t.message.includes("fetch"))&&(s="❌ Netzwerkfehler / Network Error"),a.textContent=s,a.disabled=!1,setTimeout(()=>{a.classList.remove("error"),a.textContent=e},3e3)}function Ta(){document.addEventListener("click",async a=>{const e=a.target.closest("#shareCaseLink");e&&await Ca(e);const t=a.target.closest("#submitAcknowledgment");t&&await Ma(t)}),document.addEventListener("change",a=>{a.target.id==="avdAcknowledgment"&&Ia(a.target)}),console.log("[ShareHandlers] Share handlers initialized")}async function Ca(a){try{a.disabled=!0;const e=a.textContent;a.textContent="⏳ Generiere Link... / Generating Link...";const t=await Ps();await Rs(t)?(a.classList.add("success"),a.textContent=`✓ ${o("shareCaseCopied")}`,La(a,o("shareCaseCopied")),setTimeout(()=>{a.classList.remove("success"),a.textContent=e,a.disabled=!1},5e3)):(alert(`Link generated:

${t}

Please copy this link manually.`),a.textContent=e,a.disabled=!1)}catch(e){console.error("[ShareHandlers] Failed to share case:",e),a.classList.add("error"),a.textContent="❌ Fehler / Error",a.disabled=!1,setTimeout(()=>{a.classList.remove("error"),a.textContent=`📲 ${o("shareCase")}`},3e3)}}function Ia(a){const e=document.getElementById("submitAcknowledgment");e&&(e.disabled=!a.checked)}async function Ma(a){try{const e=Ue();if(!e.isShared||!e.caseId){console.error("[ShareHandlers] No case ID found");return}a.disabled=!0;const t=a.textContent;if(a.textContent="⏳ Speichern... / Saving...",await Fs(e.caseId)){a.classList.add("success"),a.textContent=`✓ ${o("acknowledgmentSuccess")}`;const n=document.getElementById("acknowledgmentStatus");n&&(n.innerHTML=`<span class="success-message">✓ ${o("acknowledgmentSuccess")}</span>`),setTimeout(()=>{const i=document.querySelector(".acknowledgment-section");i&&(i.innerHTML=`
            <div class="acknowledged-status">
              <span class="check-icon">✓</span>
              <span>${o("acknowledgmentSuccess")}</span>
            </div>
          `)},2e3)}else a.classList.add("error"),a.textContent="❌ Fehler / Error",a.disabled=!1,setTimeout(()=>{a.classList.remove("error"),a.textContent=t},3e3)}catch(e){console.error("[ShareHandlers] Failed to submit acknowledgment:",e),a.classList.add("error"),a.textContent="❌ Fehler / Error",a.disabled=!1}}function La(a,e){const t=document.createElement("div");t.className="share-success-toast",t.textContent=e,t.style.cssText=`
    position: fixed;
    top: 20px;
    right: 20px;
    background: #00c853;
  ...
  `,document.body.appendChild(t),setTimeout(()=>{t.style.animation="slideOut 0.3s ease",setTimeout(()=>{t.remove()},300)},4e3)}const Aa={BASE_URL:"/0825/",DEV:!1,MODE:"production",PROD:!0,SSR:!1};let N=null;async function Dt(){return v(async()=>{N=await ua(),setTimeout(()=>{Pt({background:!0,criticalOnly:!1}).then(t=>{console.info("[Main] API warmup started:",t.status||"completed")}).catch(t=>{console.warn("[Main] API warmup failed:",t.message)})},2e3);const a=N.getStatus(),e=new CustomEvent("appInitialized",{detail:{timestamp:new Date().toISOString(),status:a,version:"2.1.0",build:"production"}});return document.dispatchEvent(e),N},a=>{throw $a(a),a})}function $a(a){const e=document.getElementById("appContainer");e&&(e.innerHTML=`
      <div style="
        display: flex;
    ...
    `);const t=new CustomEvent("appInitializationFailed",{detail:{error:a.message,timestamp:new Date().toISOString(),userAgent:navigator.userAgent.substring(0,100)}});document.dispatchEvent(t)}function ft(){if(N)try{N.destroy()}catch(a){}}function xa(){document.addEventListener("visibilitychange",()=>{N&&document.visibilityState==="visible"&&(N.getStatus().isAuthenticated||window.location.reload())}),window.addEventListener("beforeunload",ft),window.addEventListener("unload",ft)}async function vt(){try{try{if(["localhost","127.0.0.1","0.0.0.0"].includes(window.location.hostname)&&!(import.meta&&Aa&&!1)&&"serviceWorker"in navigator){const n=await navigator.serviceWorker.getRegistrations();for(const i of n)try{await i.unregister()}catch(r){}window.addEventListener("beforeinstallprompt",i=>{i.preventDefault()})}}catch(s){}xa(),await Dt();const a=Ue();if(a.isShared&&a.caseId){console.log("[Main] Shared link detected - loading case:",a.caseId);try{const s=await Ds(a.caseId);s.results&&h.setState({results:s.results}),s.formData&&h.setState({formData:s.formData}),h.navigate("results");const n=document.getElementById("appContainer");n&&te(n),console.log("[Main] Shared case loaded successfully")}catch(s){console.error("[Main] Failed to load shared case:",s);const n=document.getElementById("appContainer");n&&(n.innerHTML=`
          ...
          `);return}}const e=we();if(e.isKioskMode){console.log("[Main] Kiosk mode detected - loading case:",e.caseId);try{await ys(e.caseId);const s=document.getElementById("appContainer");s&&te(s)}catch(s){console.error("[Main] Failed to load kiosk case:",s);const n=document.getElementById("appContainer");n&&(n.innerHTML=`
            <div class="container" style="text-align: center; padding: 40px;">
              <h2>⚠️ Case Not Found</h2>
          ...
          `);return}}ya(),Ta();const t=new CustomEvent("appReady",{detail:{timestamp:new Date().toISOString(),version:"2.1.0"}});document.dispatchEvent(t)}catch(a){}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",vt):vt();typeof window!="undefined"&&(window.iGFAPApp={getApp:()=>N,getStatus:()=>(N==null?void 0:N.getStatus())||{error:"App not initialized"},restart:async()=>(N&&N.destroy(),Dt()),getCurrentScreen:()=>{try{return h.getState().currentScreen}catch(a){return"unknown"}},forceResults:()=>{try{h.navigate("results");const a=document.getElementById("appContainer");return a&&te(a),!0}catch(a){return!1}}});
//# sourceMappingURL=index-DPQy4TbX.js.map
